...
urlpatterns = [
    ...
    path("task-response-detail/<str:uuid>/", views.PreRegisterTaskResponseDetail.as_view(), name="task-response-detail"),
    ...
    path("personal-tests-result/<str:test_uuid>/", views.PersonalTestsResult.as_view(), name="personal-tests-result"),
