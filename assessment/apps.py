...
class AssessmentConfig(AppConfig):
    ...
    #     default_data = [
    #         {'name': 'ارزیابی بخش تکنولوژی ایده و محصول', 'key_name': "plan"},
    #         {'name': 'ارزیابی بخش کسب‌وکار ایده و محصول', 'key_name': "business"},
    #         {'name': 'ارزیابی افراد', 'key_name': "individual"},
    #         {'name': 'ارزیابی تیم', 'key_name': "team"},
    #         {'name': 'ارزیابی مهارت‌های توسعه تکنولوژی', 'key_name': "challenge_tech"},
